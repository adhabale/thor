...
export class UpstreamLossComponent implements OnInit {
  ...
  public upStreamLossData = [
    {
      ...
      "shellWell": [{ "id": 0, "name": "Either" }, { "id": 1, "name": "N" }, { "id": 3, "name": "N" }],
      "UGBlowout": [{ "id": 0, "name": "Either" }, { "id": 1, "name": "N" }, { "id": 3, "name": "N" }]
    }
  ]
