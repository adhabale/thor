...
export class LossDataSubmissionHistoryComponent implements OnInit {
  ...
  public lossDataSubmissionData = [
    { subId: '12345', referenceFile: '21242', customerName: 'British Petroleum', lossType: 'Up Stream', submittedBy: 'John Davis', Date: '25-Apr-2018 13:05', Status: 'Submitted', StatusComment: 'All Information Valid' },
    { subId: '56524', referenceFile: '32312', customerName: 'Austria Oil and Gas', lossType: 'Up Stream', submittedBy: 'John Davis', Date: '30-Apr-2018 13:10', Status: 'On-Hold', StatusComment: 'Information not valid for further actions' },
    { subId: '32123', referenceFile: '54542', customerName: 'American Oil Inc.', lossType: 'Downstream', submittedBy: 'John Davis', Date: '30-Apr-2018 15:30', Status: 'Approved', StatusComment: 'Not Valid Loss Type' },
    { subId: '87872', referenceFile: '29876', customerName: 'British Petroleum', lossType: 'Power', submittedBy: 'John Davis', Date: '30-Apr-2018 09:30', Status: 'Rejected', StatusComment: 'Need More Information' },
    { subId: '98981', referenceFile: '98262', customerName: 'British Petroleum', lossType: 'Power', submittedBy: 'John Davis', Date: '30-Apr-2018 10:45', Status: 'Submitted', StatusComment: 'Need More Information' },
    { subId: '76767', referenceFile: '64528', customerName: 'British Oil Inc.', lossType: 'Up Stream', submittedBy: 'John Davis', Date: '30-Apr-2018 14:45', Status: 'Submitted', StatusComment: 'Valid' },
    { subId: '12332', referenceFile: '19092', customerName: 'Antar Petroleum', lossType: 'Up Stream', submittedBy: 'John Davis', Date: '30-Apr-2018 15:30', Status: 'Rejected', StatusComment: 'Not Valid Loss Type' },
    { subId: '24314', referenceFile: '67261', customerName: 'British Petroleum', lossType: 'Downstream', submittedBy: 'John Davis', Date: '30-Apr-2018 13:50', Status: 'On-Hold', StatusComment: 'Need More Information' },
    { subId: '87171', referenceFile: '19802', customerName: 'British Oil and Gas', lossType: 'Up Stream', submittedBy: 'John Davis', Date: '30-Apr-2018 17:30', Status: 'Submitted', StatusComment: 'Need More Information' },
    { subId: '32123', referenceFile: '54542', customerName: 'Columbia Oil Inc.', lossType: 'Downstream', submittedBy: 'John Davis', Date: '30-Apr-2018 19:30', Status: 'Approved', StatusComment: 'Information Done and Verified' },
    { subId: '87872', referenceFile: '29876', customerName: 'Canada Petroleum', lossType: 'Power', submittedBy: 'John Davis', Date: '30-Apr-2018 16:00', Status: 'Rejected', StatusComment: 'Information not valid' },
    { subId: '98981', referenceFile: '98262', customerName: 'British Petroleum', lossType: 'Power', submittedBy: 'John Davis', Date: '30-Apr-2018 17:40', Status: 'Submitted', StatusComment: 'Information corrected but not verified' }
  ...
  openReadOnlyMode(selectedLossType: string) {
